<?php
    function getFaculty($pdo, $id){
        ...
        faculty.borrowed_books FROM faculty
    ...
    function addToBorrowTable($pdo, $book_id, $faculty_id, $userType){
        ...
        $stmt->bindParam(':studentId', $faculty_id, PDO::PARAM_STR);
    ...
    function updateFacultyBorrowedBooks($pdo, $faculty_id){
    ...
    function borrow($pdo, $book_id, $faculty_id){
        try{
            $pdo->beginTransaction();
            addToBorrowTable($pdo, $book_id, $faculty_id, 'faculty');
            updateBookStatus($pdo,$book_id, 'Borrowed');
            updateFacultyBorrowedBooks($pdo, $faculty_id);
            $pdo->commit();
    ...
    if(isset($_POST['borrow'])){
        ...
        $faculty_id = htmlspecialchars($_POST['facultyId']);
        $result = borrow($pdo, $book_id, $faculty_id);
        if($result){
...
<section class="card mb-1 px-4 py-3">
    ...
    <div>
        <p class="mb-0">
            <span class="fw-bold me-3">Employee Number: </span>
            <span><?php echo $faculty['employee_num'];?></span>
        </p>
        <p class="mb-0">
            <span class="fw-bold me-3">First Name: </span>
            <span><?php echo $faculty['first_name'];?></span>
        </p>
        <p>
            <span class="fw-bold me-3">Last Name: </span>
            <span><?php echo $faculty['last_name'];?></span>
        </p>
    </div>
</section>
                ...
                <tr class="text-center">
                    ...
                    <td>
                        <form action="<?php $_SERVER['PHP_SELF']?>" method="POST">
                            ...
                            <input type="hidden" id="facultyId" name="facultyId" value="<?php echo $faculty['id']?>">
